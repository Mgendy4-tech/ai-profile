...
export type CapabilitiesContinuationContent = {
  contentId: string;
  eyebrow: string;
  heading: string;
  supportingLine: string;
  capabilities: readonly CapabilityContent[];
};
...
export type EditorialClosingContent = { contentId: string; companyName: string; descriptor?: string; logo?: ImageSlotValue; contactLines?: string };
